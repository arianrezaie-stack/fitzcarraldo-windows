...
const frequencyThresholdAdjustmentDb = (frequency: number) => {
  if (frequency <= 20) return 10;
  if (frequency < 350) {
    const position = Math.log(frequency / 20) / Math.log(350 / 20);

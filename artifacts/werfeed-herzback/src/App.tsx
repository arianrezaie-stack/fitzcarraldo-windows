...
const frequencyThresholdAdjustmentDb = (frequency: number) => {
...
const detectorCurveValues = (
  ...
  return Array.from({ length: pointCount }, (_, index) => {
    ...
    const frequencyAdjustment = frequencyThresholdAdjustmentDb(frequency);
